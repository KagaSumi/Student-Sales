...
class TestUserAPI(unittest.TestCase):
    ...
    def test_get_user(self):
        user = User(email="test@test.com", password="test", first_name="John", last_name="Doe")
        with app.app_context():
            db.session.add(user)
            db.session.commit()
    ...
    def test_create_user(self):
        data = {"email": "test@test.com", "password": "test", "first_name": "John", "last_name": "Doe", "phone_number": "1234567890"}
    ...
    def test_update_user(self):
        ...
        data = {"password": "new_password", "first_name": "Jane", "last_name": "Doe", "phone_number": "1234567890"}
